...
nsamps <- 81
set.seed(25)
R1Samps <- sample_n(subset(pdat,Region=='R1'),nsamps)
R2Samps <- sample_n(subset(pdat,Region=='R2'),nsamps)
R3Samps <- sample_n(subset(pdat,Region=='R3'),nsamps)
R4Samps <- sample_n(subset(pdat,Region=='R4'),nsamps)

...
g1 <- ggplot(AllScores,aes(x=PC1,y=PC2))+
  ...
  theme_bw()
g1
ggsave('NewPCA_BiPlot.pdf',width=5.5,height=2.2,units="in")
####################
## Plot Loadings
# Add Label
TPOCorrs$Type ="Size";
...
NoTPOCorrs$ID = TPOCorrs$ID

g1a <- ggplot(NoTPOCorrs,aes(x=reorder(ID,-PC1),y=PC1))+
  geom_bar(stat="identity")+
  theme_bw()+
  ylim(0,1)+
  theme(text = element_text(size=8),axis.text.x=element_text(angle=0,size=6))
g1a
ggsave('NewPCA_NoTPO_PC1Corrs.pdf',width=2.75,height=1.1,units="in")

g1b <- ggplot(NoTPOCorrs,aes(x=reorder(ID,-PC2),y=PC2))+
  geom_bar(stat="identity")+
  theme_bw()+
  ylim(0,1)+
  theme(text = element_text(size=8),axis.text.x=element_text(angle=0,size=6))
g1b
ggsave('NewPCA_NoTPO_PC2Corrs.pdf',width=2.75,height=1.1,units="in")

g1c <- ggplot(TPOCorrs,aes(x=reorder(ID,-PC1),y=PC1))+
  geom_bar(stat="identity")+
  theme_bw()+
  ylim(0,1)+
  theme(text = element_text(size=8),axis.text.x=element_text(angle=0,size=6))
g1c
ggsave('NewPCA_TPO_PC1Corrs.pdf',width=2.75,height=1.1,units="in")

g1d <- ggplot(TPOCorrs,aes(x=reorder(ID,-PC2),y=PC2))+
  geom_bar(stat="identity")+
  theme_bw()+
  ylim(0,1)+
  theme(text = element_text(size=8),axis.text.x=element_text(angle=0,size=6))
g1d
ggsave('NewPCA_TPO_PC2Corrs.pdf',width=2.75,height=1.1,units="in")
...
g2
ggsave('NewPCA_ScreePlot.pdf',width=5.5,height=2,units="in")
...
g4 <- ggplot(LinNegDat,aes(x=Area,y=Circularity))+
  ...
  theme(text = element_text(size=8))
g4
ggsave('AreaVCircularity.pdf',width=5.5,height=2.2,units="in")
...
ggsave('FlowComparison.pdf',width=5.5,height=2.2,units="in")
...
g7 <- ggplot(TDat,aes(x=PC1,y=PC2))+
  ...
  theme(text = element_text(size=8))
g7
ggsave('NewPCA_Sca1BiPlot.pdf',width=5.5,height=2.2,units="in")
...
g7a <- ggplot(TDat,aes(x=PC1,y=PC2))+
  ...
  theme(text = element_text(size=8))
g7a
ggsave('NewPCA_cKitBiPlot.pdf',width=5.5,height=2.2,units="in")
